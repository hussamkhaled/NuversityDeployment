...
INSERT INTO digid.mmesage (uid, msg_subject, msg_body) VALUES('M001', 'Forget Password', '$username$ open the link to reset your password $link$');
INSERT INTO digid.mmesage (uid, msg_subject, msg_body) VALUES('M003', 'Student Accepted', 'You are student now, you can login with your NUmail $numail$');

INSERT INTO digid.mmesage (uid, msg_subject, msg_body) VALUES('M002', 'Set Password', '$username$ open the link to set your password $link$. Your nuid is $nuid$');
create table RTYPE (
UID VARCHAR(128) primary key,
